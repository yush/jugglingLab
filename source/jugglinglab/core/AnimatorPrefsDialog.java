...
public class AnimatorPrefsDialog extends JDialog {
    ...
    public AnimatorPrefsDialog(JFrame parent) {
        ...
        p1.add(tf1);
        gb.setConstraints(tf1, make_constraints(GridBagConstraints.WEST,0,0,
                                                new Insets(0,0,0,0)));
        ...
        p1.add(tf2);
        gb.setConstraints(tf2, make_constraints(GridBagConstraints.WEST,0,1,
                                                new Insets(0,0,0,0)));
        ...
        p1.add(tf3);
        gb.setConstraints(tf3, make_constraints(GridBagConstraints.WEST,0,2,
                                                new Insets(0,0,0,0)));
        ...
        but2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    new ErrorDialog(AnimatorPrefsDialog.this, errorstrings.getString("Error_number_format_fps"));
                }
                try {
                    tempdouble = Double.valueOf(tf2.getText()).doubleValue();
                    if (tempdouble > 0.0) newjc.slowdown = tempdouble;
                } catch (NumberFormatException e) {
                    new ErrorDialog(AnimatorPrefsDialog.this, errorstrings.getString("Error_number_format_slowdown"));
                }
                try {
                    tempint = Integer.parseInt(tf3.getText());
                    if (tempint >= 0) newjc.border = tempint;
                } catch (NumberFormatException e) {
                    new ErrorDialog(AnimatorPrefsDialog.this, errorstrings.getString("Error_number_format_border"));
                }
        ...
        gb.setConstraints(cb0, make_constraints(GridBagConstraints.WEST,0,0,
                                                new Insets(border,border,0,border)));
        this.getContentPane().add(cb3);
        gb.setConstraints(cb3, make_constraints(GridBagConstraints.WEST,0,1,
                                                new Insets(0,border,0,border)));
        this.getContentPane().add(cb1);
        gb.setConstraints(cb1, make_constraints(GridBagConstraints.WEST,0,2,
                                                new Insets(0,border,0,border)));
        this.getContentPane().add(cb2);
        gb.setConstraints(cb2, make_constraints(GridBagConstraints.WEST,0,3,
                                                new Insets(0,border,0,border)));
        this.getContentPane().add(cb6);
        gb.setConstraints(cb6, make_constraints(GridBagConstraints.WEST,0,4,
                                                new Insets(0,border,0,border)));
        this.getContentPane().add(cb4);
        gb.setConstraints(cb4, make_constraints(GridBagConstraints.WEST,0,5,
                                                new Insets(0,border,0,border)));
        this.getContentPane().add(cb5);
        gb.setConstraints(cb5, make_constraints(GridBagConstraints.WEST,0,6,
                                                new Insets(0,border,3,border)));
        this.getContentPane().add(p1);		// now make the whole window
        gb.setConstraints(p1, make_constraints(GridBagConstraints.WEST,0,7,
                                               new Insets(3,border,border,border)));
        this.getContentPane().add(p2);
        gb.setConstraints(p2, make_constraints(GridBagConstraints.EAST,0,8,
